...
export default function Navbar() {
  return (
    <div className="bg-black h-12 mt-5 px-4 rounded-xl text-white flex justify-between items-center">
      <span className="font-['Dancing_Script'] font-bold text-3xl">Thoughts</span>
